...
//    console.log("children removed");
  ...
  addEventListeners: function () {
    ...
    if (this.data.controls && this.data.controllerID) {
      ...
      controllerEl.addEventListener('gripup', this.handReleased.bind(this));
      controllerEl.addEventListener('gripdown', this.handSqueezed.bind(this));
      controllerEl.addEventListener('ybuttondown', this.onTriggerDown.bind(this));
    }
  ...
  removeEventListeners: function () {
    if (this.data.controls && this.data.controllerID) {
      ...
      controllerEl.removeEventListener('gripup', this.handReleased);
      controllerEl.removeEventListener('gripdown', this.handSqueezed);
      controllerEl.removeEventListener('ybuttondown', this.onTriggerDown);
    }
...
//     } else if (Date.now() - this.prevTime > 1000) {
//       this.onOptionSwitch("next");
//       this.prevTime = Date.now();
//     }
//   }
